...
Generated: 2026-01-06 13:16:26 UTC
...
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 3.49 µs (19 allocs) | 4.28 µs (16 allocs) | unsupported | 3.59 µs (26 allocs) | unsupported | 5.43 µs (46 allocs) |
| Complex | 9.88 µs (39 allocs) | 11.20 µs (33 allocs) | unsupported | 10.44 µs (78 allocs) | unsupported | 17.42 µs (153 allocs) |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 11.79 µs (110 allocs) | 16.72 µs (187 allocs) | unsupported | 30.06 µs (255 allocs) | 26.48 µs (305 allocs) | 6.66 µs (72 allocs) |
| Complex | 28.71 µs (270 allocs) | unsupported | unsupported | 73.98 µs (515 allocs) | 7.54 µs (75 allocs) | 23.28 µs (243 allocs) |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Uncached | 23.63 µs (204 allocs) | unsupported | unsupported | 30.60 µs (255 allocs) | unsupported | unsupported |
| Cached | 18 ns (0 allocs) | unsupported | unsupported | 635 ns (6 allocs) | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Uncached | 22.68 µs (202 allocs) | unsupported | unsupported | 30.49 µs (255 allocs) | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 1.44 µs (10 allocs) | 2.15 µs (7 allocs) | 12.73 µs (43 allocs) | unsupported | 6.30 µs (48 allocs) | unsupported |
| Complex | 2.25 µs (15 allocs) | 3.46 µs (9 allocs) | 12.26 µs (139 allocs) | unsupported | 13.85 µs (120 allocs) | unsupported |
| Large | 1.58 µs (22 allocs) | 1.87 µs (3 allocs) | 46.86 µs (254 allocs) | unsupported | 14.78 µs (126 allocs) | unsupported |
...
| Playground | 2.15 µs | 7 | 1.50x slower |
| Ozzo | 12.73 µs | 43 | 8.87x slower |
| Huma | - | - | - |
| Godantic | 6.30 µs | 48 | 4.39x slower |
| Godasse | - | - | - |
...
| Playground | 3.46 µs | 9 | 1.53x slower |
| Ozzo | 12.26 µs | 139 | 5.44x slower |
| Huma | - | - | - |
| Godantic | 13.85 µs | 120 | 6.14x slower |
| Godasse | - | - | - |
...
| Ozzo | - | - | - |
| Huma | 3.59 µs | 26 | 1.03x slower |
| Godantic | - | - | - |
| Godasse | 5.43 µs | 46 | 1.56x slower |
...
| Playground | 11.20 µs | 33 | 1.13x slower |
| Ozzo | - | - | - |
| Huma | 10.44 µs | 78 | 1.06x slower |
| Godantic | - | - | - |
| Godasse | 17.42 µs | 153 | 1.76x slower |

### Schema_Uncached (first-time generation)

| Library | ns/op | allocs | vs Pedantigo |
|---------|-------|--------|-------------|
| Pedantigo | 22.68 µs | 202 | baseline |
| Playground | - | - | - |
| Ozzo | - | - | - |
| Huma | 30.49 µs | 255 | 1.34x slower |
| Godantic | - | - | - |
| Godasse | - | - | - |
