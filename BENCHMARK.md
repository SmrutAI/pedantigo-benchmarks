...
Generated: 2026-09-03 02:01:27 UTC
...
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 1.49 µs (10 allocs) | 2.20 µs (7 allocs) | 13.25 µs (43 allocs) | unsupported | 6.18 µs (48 allocs) | unsupported |
| Complex | 2.73 µs (15 allocs) | 3.54 µs (9 allocs) | 12.78 µs (139 allocs) | unsupported | 14.99 µs (120 allocs) | unsupported |
| Large | 1.65 µs (22 allocs) | 1.84 µs (3 allocs) | 47.89 µs (254 allocs) | unsupported | 14.92 µs (126 allocs) | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 3.51 µs (19 allocs) | 4.30 µs (16 allocs) | unsupported | 3.56 µs (26 allocs) | unsupported | unsupported |
| Complex | 10.27 µs (39 allocs) | 11.05 µs (33 allocs) | unsupported | 10.47 µs (78 allocs) | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 1.98 µs (11 allocs) | 2.82 µs (9 allocs) | unsupported | unsupported | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 5.30 µs (41 allocs) | unsupported | unsupported | unsupported | 11.82 µs (81 allocs) | 4.68 µs (42 allocs) |
| Complex | 14.76 µs (122 allocs) | unsupported | unsupported | unsupported | 50.96 µs (285 allocs) | 16.44 µs (149 allocs) |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 16.46 µs (121 allocs) | 16.63 µs (187 allocs) | unsupported | 31.51 µs (255 allocs) | 27.51 µs (305 allocs) | 6.94 µs (72 allocs) |
| Complex | 48.75 µs (359 allocs) | unsupported | unsupported | 77.50 µs (515 allocs) | 7.70 µs (75 allocs) | 24.33 µs (243 allocs) |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Uncached | 28.96 µs (219 allocs) | unsupported | unsupported | 32.06 µs (255 allocs) | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Uncached | 29.97 µs (221 allocs) | unsupported | unsupported | 31.85 µs (255 allocs) | unsupported | unsupported |
| Cached | 18 ns (0 allocs) | unsupported | unsupported | 666 ns (6 allocs) | unsupported | unsupported |
...
| Playground | 2.20 µs | 7 | 1.48x slower |
| Ozzo | 13.25 µs | 43 | 8.88x slower |
| Huma | - | - | - |
| Godantic | 6.18 µs | 48 | 4.14x slower |
| Godasse | - | - | - |
...
| Library | ns/op | allocs | vs Pedantigo |
|---------|-------|--------|-------------|
| Pedantigo | 2.73 µs | 15 | baseline |
| Playground | 3.54 µs | 9 | 1.30x slower |
| Ozzo | 12.78 µs | 139 | 4.68x slower |
| Huma | - | - | - |
| Godantic | 14.99 µs | 120 | 5.49x slower |
| Godasse | - | - | - |
...
| Library | ns/op | allocs | vs Pedantigo |
|---------|-------|--------|-------------|
| Pedantigo | 3.51 µs | 19 | baseline |
| Playground | 4.30 µs | 16 | 1.23x slower |
| Ozzo | - | - | - |
| Huma | 3.56 µs | 26 | 1.01x slower |
| Godantic | - | - | - |
| Godasse | - | - | - |
...
| Library | ns/op | allocs | vs Pedantigo |
|---------|-------|--------|-------------|
| Pedantigo | 10.27 µs | 39 | baseline |
| Playground | 11.05 µs | 33 | 1.08x slower |
| Ozzo | - | - | - |
| Huma | 10.47 µs | 78 | 1.02x slower |
| Godantic | - | - | - |
| Godasse | - | - | - |
...
| Library | ns/op | allocs | vs Pedantigo |
|---------|-------|--------|-------------|
| Pedantigo | 5.30 µs | 41 | baseline |
| Playground | - | - | - |
| Ozzo | - | - | - |
| Huma | - | - | - |
| Godantic | 11.82 µs | 81 | 2.23x slower |
| Godasse | 4.68 µs | 42 | 1.13x faster |

### Unmarshal_Complex (nested JSON, single call)

| Library | ns/op | allocs | vs Pedantigo |
|---------|-------|--------|-------------|
| Pedantigo | 14.76 µs | 122 | baseline |
| Playground | - | - | - |
| Ozzo | - | - | - |
| Huma | - | - | - |
| Godantic | 50.96 µs | 285 | 3.45x slower |
| Godasse | 16.44 µs | 149 | 1.11x slower |

### Schema_Uncached (first-time generation)

| Library | ns/op | allocs | vs Pedantigo |
|---------|-------|--------|-------------|
| Pedantigo | 28.96 µs | 219 | baseline |
| Playground | - | - | - |
| Ozzo | - | - | - |
| Huma | 32.06 µs | 255 | 1.11x slower |
| Godantic | - | - | - |
| Godasse | - | - | - |
