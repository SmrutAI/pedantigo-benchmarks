...
Generated: 2025-12-20 03:11:32 UTC
...
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 1.90 µs (11 allocs) | 2.72 µs (9 allocs) | unsupported | unsupported | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 12.04 µs (110 allocs) | 17.07 µs (187 allocs) | unsupported | 30.37 µs (255 allocs) | 26.91 µs (305 allocs) | 6.76 µs (72 allocs) |
| Complex | 28.73 µs (270 allocs) | unsupported | unsupported | 74.62 µs (515 allocs) | 7.61 µs (75 allocs) | 23.73 µs (243 allocs) |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Uncached | 23.67 µs (204 allocs) | unsupported | unsupported | 31.08 µs (255 allocs) | unsupported | unsupported |
| Cached | 19 ns (0 allocs) | unsupported | unsupported | 649 ns (6 allocs) | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Uncached | 22.66 µs (202 allocs) | unsupported | unsupported | 30.66 µs (255 allocs) | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 3.50 µs (19 allocs) | 4.30 µs (16 allocs) | unsupported | unsupported | unsupported | unsupported |
| Complex | 9.98 µs (39 allocs) | 11.13 µs (33 allocs) | unsupported | unsupported | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 5.05 µs (39 allocs) | unsupported | unsupported | 3.62 µs (26 allocs) | unsupported | 5.52 µs (46 allocs) |
| Complex | 18.52 µs (135 allocs) | unsupported | unsupported | 10.47 µs (78 allocs) | unsupported | 17.69 µs (153 allocs) |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 1.45 µs (10 allocs) | 2.18 µs (7 allocs) | 12.77 µs (43 allocs) | unsupported | 6.05 µs (48 allocs) | unsupported |
| Complex | 2.28 µs (15 allocs) | 3.47 µs (9 allocs) | 12.34 µs (139 allocs) | unsupported | 13.85 µs (120 allocs) | unsupported |
| Large | 1.60 µs (22 allocs) | 1.89 µs (3 allocs) | 47.16 µs (254 allocs) | unsupported | 14.79 µs (126 allocs) | unsupported |
...
| Playground | 2.18 µs | 7 | 1.51x slower |
| Ozzo | 12.77 µs | 43 | 8.83x slower |
| Huma | - | - | - |
| Godantic | 6.05 µs | 48 | 4.19x slower |
| Godasse | - | - | - |
...
| Playground | 3.47 µs | 9 | 1.52x slower |
| Ozzo | 12.34 µs | 139 | 5.40x slower |
| Huma | - | - | - |
| Godantic | 13.85 µs | 120 | 6.07x slower |
| Godasse | - | - | - |
...
| Playground | - | - | - |
| Ozzo | - | - | - |
| Huma | 3.62 µs | 26 | 1.40x faster |
| Godantic | - | - | - |
| Godasse | 5.52 µs | 46 | 1.09x slower |

### UnmarshalMap_Complex (nested JSON)

| Library | ns/op | allocs | vs Pedantigo |
|---------|-------|--------|-------------|
| Pedantigo | 18.52 µs | 135 | baseline |
| Playground | - | - | - |
| Ozzo | - | - | - |
| Huma | 10.47 µs | 78 | 1.77x faster |
| Godantic | - | - | - |
| Godasse | 17.69 µs | 153 | 1.05x faster |

### Schema_Uncached (first-time generation)

| Library | ns/op | allocs | vs Pedantigo |
|---------|-------|--------|-------------|
| Pedantigo | 22.66 µs | 202 | baseline |
| Playground | - | - | - |
| Ozzo | - | - | - |
| Huma | 30.66 µs | 255 | 1.35x slower |
| Godantic | - | - | - |
| Godasse | - | - | - |
