...
Generated: 2026-08-08 01:53:31 UTC
...
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 1.30 µs (10 allocs) | 2.13 µs (7 allocs) | 12.07 µs (43 allocs) | unsupported | 5.50 µs (48 allocs) | unsupported |
| Complex | 2.06 µs (15 allocs) | 3.49 µs (9 allocs) | 11.47 µs (139 allocs) | unsupported | 12.65 µs (120 allocs) | unsupported |
| Large | 1.45 µs (22 allocs) | 1.73 µs (3 allocs) | 43.81 µs (254 allocs) | unsupported | 13.59 µs (126 allocs) | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 3.23 µs (19 allocs) | 4.11 µs (16 allocs) | unsupported | 3.38 µs (26 allocs) | unsupported | unsupported |
| Complex | 8.93 µs (39 allocs) | 10.37 µs (33 allocs) | unsupported | 9.87 µs (78 allocs) | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 1.76 µs (11 allocs) | 2.67 µs (9 allocs) | unsupported | unsupported | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 4.72 µs (39 allocs) | unsupported | unsupported | unsupported | 11.13 µs (81 allocs) | 4.44 µs (42 allocs) |
| Complex | 14.56 µs (122 allocs) | unsupported | unsupported | unsupported | 46.90 µs (285 allocs) | 15.87 µs (149 allocs) |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 14.94 µs (129 allocs) | 15.38 µs (187 allocs) | unsupported | 30.03 µs (255 allocs) | 25.97 µs (305 allocs) | 6.39 µs (72 allocs) |
| Complex | 35.04 µs (299 allocs) | unsupported | unsupported | 74.66 µs (515 allocs) | 7.23 µs (75 allocs) | 22.18 µs (243 allocs) |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Uncached | 26.27 µs (227 allocs) | unsupported | unsupported | 30.14 µs (255 allocs) | unsupported | unsupported |
| Cached | 23 ns (0 allocs) | unsupported | unsupported | 586 ns (6 allocs) | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Uncached | 27.09 µs (229 allocs) | unsupported | unsupported | 30.24 µs (255 allocs) | unsupported | unsupported |
| Cached | 23 ns (0 allocs) | unsupported | unsupported | 583 ns (6 allocs) | unsupported | unsupported |
...
| Playground | 2.13 µs | 7 | 1.64x slower |
| Ozzo | 12.07 µs | 43 | 9.30x slower |
| Huma | - | - | - |
| Godantic | 5.50 µs | 48 | 4.23x slower |
| Godasse | - | - | - |
...
| Playground | 3.49 µs | 9 | 1.70x slower |
| Ozzo | 11.47 µs | 139 | 5.57x slower |
| Huma | - | - | - |
| Godantic | 12.65 µs | 120 | 6.15x slower |
| Godasse | - | - | - |
...
| Playground | 4.11 µs | 16 | 1.27x slower |
| Ozzo | - | - | - |
| Huma | 3.38 µs | 26 | 1.05x slower |
| Godantic | - | - | - |
| Godasse | - | - | - |
...
| Playground | 10.37 µs | 33 | 1.16x slower |
| Ozzo | - | - | - |
| Huma | 9.87 µs | 78 | 1.11x slower |
| Godantic | - | - | - |
| Godasse | - | - | - |
...
| Library | ns/op | allocs | vs Pedantigo |
|---------|-------|--------|-------------|
| Pedantigo | 4.72 µs | 39 | baseline |
| Playground | - | - | - |
| Ozzo | - | - | - |
| Huma | - | - | - |
| Godantic | 11.13 µs | 81 | 2.36x slower |
| Godasse | 4.44 µs | 42 | 1.06x faster |

### Unmarshal_Complex (nested JSON, single call)

| Library | ns/op | allocs | vs Pedantigo |
|---------|-------|--------|-------------|
| Pedantigo | 14.56 µs | 122 | baseline |
| Playground | - | - | - |
| Ozzo | - | - | - |
| Huma | - | - | - |
| Godantic | 46.90 µs | 285 | 3.22x slower |
| Godasse | 15.87 µs | 149 | 1.09x slower |

### Schema_Uncached (first-time generation)

| Library | ns/op | allocs | vs Pedantigo |
|---------|-------|--------|-------------|
| Pedantigo | 26.27 µs | 227 | baseline |
| Playground | - | - | - |
| Ozzo | - | - | - |
| Huma | 30.14 µs | 255 | 1.15x slower |
| Godantic | - | - | - |
| Godasse | - | - | - |
...
| Library | ns/op | allocs | vs Pedantigo |
|---------|-------|--------|-------------|
| Pedantigo | 23 ns | 0 | baseline |
| Playground | - | - | - |
| Ozzo | - | - | - |
| Huma | 586 ns | 6 | 25.09x slower |
| Godantic | - | - | - |
| Godasse | - | - | - |
