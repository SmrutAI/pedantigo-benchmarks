...
Generated: 2025-12-20 11:59:43 UTC
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 11.73 µs (110 allocs) | 16.11 µs (187 allocs) | unsupported | 29.91 µs (255 allocs) | 26.57 µs (305 allocs) | 6.66 µs (72 allocs) |
| Complex | 28.59 µs (270 allocs) | unsupported | unsupported | 73.49 µs (515 allocs) | 7.48 µs (75 allocs) | 23.14 µs (243 allocs) |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Uncached | 23.41 µs (204 allocs) | unsupported | unsupported | 30.25 µs (255 allocs) | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Uncached | 22.57 µs (202 allocs) | unsupported | unsupported | 30.09 µs (255 allocs) | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 3.44 µs (19 allocs) | 4.24 µs (16 allocs) | unsupported | unsupported | unsupported | unsupported |
| Complex | 9.79 µs (39 allocs) | 11.04 µs (33 allocs) | unsupported | unsupported | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 5.06 µs (39 allocs) | unsupported | unsupported | 3.50 µs (26 allocs) | unsupported | 5.40 µs (46 allocs) |
| Complex | 18.18 µs (135 allocs) | unsupported | unsupported | 10.32 µs (78 allocs) | unsupported | 17.37 µs (153 allocs) |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 1.41 µs (10 allocs) | 2.14 µs (7 allocs) | 12.79 µs (43 allocs) | unsupported | 6.00 µs (48 allocs) | unsupported |
| Complex | 2.25 µs (15 allocs) | 3.43 µs (9 allocs) | 12.29 µs (139 allocs) | unsupported | 13.81 µs (120 allocs) | unsupported |
| Large | 1.58 µs (22 allocs) | 1.85 µs (3 allocs) | 46.57 µs (254 allocs) | unsupported | 14.70 µs (126 allocs) | unsupported |
...
| Playground | 2.14 µs | 7 | 1.52x slower |
| Ozzo | 12.79 µs | 43 | 9.05x slower |
| Huma | - | - | - |
| Godantic | 6.00 µs | 48 | 4.24x slower |
| Godasse | - | - | - |
...
| Playground | 3.43 µs | 9 | 1.53x slower |
| Ozzo | 12.29 µs | 139 | 5.46x slower |
| Huma | - | - | - |
| Godantic | 13.81 µs | 120 | 6.13x slower |
| Godasse | - | - | - |
...
| Godantic | - | - | - |
| Godasse | 5.40 µs | 46 | 1.07x slower |

### UnmarshalMap_Complex (nested JSON)

| Library | ns/op | allocs | vs Pedantigo |
|---------|-------|--------|-------------|
| Pedantigo | 18.18 µs | 135 | baseline |
| Playground | - | - | - |
| Ozzo | - | - | - |
| Huma | 10.32 µs | 78 | 1.76x faster |
| Godantic | - | - | - |
| Godasse | 17.37 µs | 153 | 1.05x faster |

### Schema_Uncached (first-time generation)

| Library | ns/op | allocs | vs Pedantigo |
|---------|-------|--------|-------------|
| Pedantigo | 22.57 µs | 202 | baseline |
| Playground | - | - | - |
| Ozzo | - | - | - |
| Huma | 30.09 µs | 255 | 1.33x slower |
| Godantic | - | - | - |
| Godasse | - | - | - |
