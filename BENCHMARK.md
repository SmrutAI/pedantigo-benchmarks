...
Generated: 2026-09-02 06:03:25 UTC
...
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 1.42 µs (10 allocs) | 2.28 µs (7 allocs) | 13.49 µs (43 allocs) | unsupported | 6.20 µs (48 allocs) | unsupported |
| Complex | 2.23 µs (15 allocs) | 3.69 µs (9 allocs) | 12.90 µs (139 allocs) | unsupported | 14.09 µs (120 allocs) | unsupported |
| Large | 1.64 µs (22 allocs) | 1.96 µs (3 allocs) | 48.39 µs (254 allocs) | unsupported | 14.93 µs (126 allocs) | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 3.50 µs (19 allocs) | 4.39 µs (16 allocs) | unsupported | 3.54 µs (26 allocs) | unsupported | unsupported |
| Complex | 9.94 µs (39 allocs) | 11.29 µs (33 allocs) | unsupported | 10.35 µs (78 allocs) | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 1.93 µs (11 allocs) | 2.81 µs (9 allocs) | unsupported | unsupported | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 5.13 µs (39 allocs) | unsupported | unsupported | unsupported | 11.81 µs (81 allocs) | 4.76 µs (42 allocs) |
| Complex | 16.45 µs (122 allocs) | unsupported | unsupported | unsupported | 52.53 µs (285 allocs) | 16.58 µs (149 allocs) |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 16.52 µs (129 allocs) | 17.69 µs (187 allocs) | unsupported | 31.50 µs (255 allocs) | 27.82 µs (305 allocs) | 7.01 µs (72 allocs) |
| Complex | 38.62 µs (299 allocs) | unsupported | unsupported | 76.31 µs (515 allocs) | 7.71 µs (75 allocs) | 24.10 µs (243 allocs) |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Uncached | 28.48 µs (227 allocs) | unsupported | unsupported | 33.45 µs (255 allocs) | unsupported | unsupported |
| Cached | 18 ns (0 allocs) | unsupported | unsupported | 660 ns (6 allocs) | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Uncached | 29.67 µs (229 allocs) | unsupported | unsupported | 32.02 µs (255 allocs) | unsupported | unsupported |
| Cached | 19 ns (0 allocs) | unsupported | unsupported | 663 ns (6 allocs) | unsupported | unsupported |
...
| Playground | 2.28 µs | 7 | 1.61x slower |
| Ozzo | 13.49 µs | 43 | 9.52x slower |
| Huma | - | - | - |
| Godantic | 6.20 µs | 48 | 4.37x slower |
| Godasse | - | - | - |
...
| Playground | 3.69 µs | 9 | 1.65x slower |
| Ozzo | 12.90 µs | 139 | 5.79x slower |
| Huma | - | - | - |
| Godantic | 14.09 µs | 120 | 6.32x slower |
| Godasse | - | - | - |
...
| Playground | 4.39 µs | 16 | 1.25x slower |
| Ozzo | - | - | - |
...
| Playground | 11.29 µs | 33 | 1.14x slower |
| Ozzo | - | - | - |
| Huma | 10.35 µs | 78 | 1.04x slower |
| Godantic | - | - | - |
| Godasse | - | - | - |
...
| Library | ns/op | allocs | vs Pedantigo |
|---------|-------|--------|-------------|
| Pedantigo | 5.13 µs | 39 | baseline |
| Playground | - | - | - |
| Ozzo | - | - | - |
| Huma | - | - | - |
| Godantic | 11.81 µs | 81 | 2.30x slower |
| Godasse | 4.76 µs | 42 | 1.08x faster |

### Unmarshal_Complex (nested JSON, single call)

| Library | ns/op | allocs | vs Pedantigo |
|---------|-------|--------|-------------|
| Pedantigo | 16.45 µs | 122 | baseline |
| Playground | - | - | - |
| Ozzo | - | - | - |
| Huma | - | - | - |
| Godantic | 52.53 µs | 285 | 3.19x slower |
| Godasse | 16.58 µs | 149 | 1.01x slower |

### Schema_Uncached (first-time generation)

| Library | ns/op | allocs | vs Pedantigo |
|---------|-------|--------|-------------|
| Pedantigo | 28.48 µs | 227 | baseline |
| Playground | - | - | - |
| Ozzo | - | - | - |
| Huma | 33.45 µs | 255 | 1.17x slower |
| Godantic | - | - | - |
| Godasse | - | - | - |
