...
Generated: 2026-01-06 13:46:14 UTC
...
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 3.48 µs (19 allocs) | 4.27 µs (16 allocs) | unsupported | 3.54 µs (26 allocs) | unsupported | 5.42 µs (46 allocs) |
| Complex | 9.85 µs (39 allocs) | 11.20 µs (33 allocs) | unsupported | 10.35 µs (78 allocs) | unsupported | 17.27 µs (153 allocs) |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 1.90 µs (11 allocs) | 2.70 µs (9 allocs) | unsupported | unsupported | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 11.82 µs (110 allocs) | 16.81 µs (187 allocs) | unsupported | 30.06 µs (255 allocs) | 26.57 µs (305 allocs) | 6.64 µs (72 allocs) |
| Complex | 28.36 µs (270 allocs) | unsupported | unsupported | 73.79 µs (515 allocs) | 7.46 µs (75 allocs) | 23.27 µs (243 allocs) |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Uncached | 23.63 µs (204 allocs) | unsupported | unsupported | 30.25 µs (255 allocs) | unsupported | unsupported |
| Cached | 19 ns (0 allocs) | unsupported | unsupported | 646 ns (6 allocs) | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Uncached | 22.86 µs (202 allocs) | unsupported | unsupported | 30.35 µs (255 allocs) | unsupported | unsupported |
...
| Struct | Pedantigo | Playground | Ozzo | Huma | Godantic | Godasse |
|--------|--------|--------|--------|--------|--------|--------|
| Simple | 1.45 µs (10 allocs) | 2.14 µs (7 allocs) | 12.77 µs (43 allocs) | unsupported | 6.01 µs (48 allocs) | unsupported |
| Complex | 2.25 µs (15 allocs) | 3.45 µs (9 allocs) | 12.38 µs (139 allocs) | unsupported | 13.83 µs (120 allocs) | unsupported |
| Large | 1.58 µs (22 allocs) | 1.87 µs (3 allocs) | 46.79 µs (254 allocs) | unsupported | 14.70 µs (126 allocs) | unsupported |
...
| Playground | 2.14 µs | 7 | 1.48x slower |
| Ozzo | 12.77 µs | 43 | 8.84x slower |
| Huma | - | - | - |
| Godantic | 6.01 µs | 48 | 4.16x slower |
| Godasse | - | - | - |
...
| Ozzo | 12.38 µs | 139 | 5.50x slower |
| Huma | - | - | - |
| Godantic | 13.83 µs | 120 | 6.14x slower |
| Godasse | - | - | - |
...
| Playground | 11.20 µs | 33 | 1.14x slower |
| Ozzo | - | - | - |
| Huma | 10.35 µs | 78 | 1.05x slower |
| Godantic | - | - | - |
| Godasse | 17.27 µs | 153 | 1.75x slower |
...
| Playground | - | - | - |
| Ozzo | - | - | - |
| Huma | 30.35 µs | 255 | 1.33x slower |
| Godantic | - | - | - |
| Godasse | - | - | - |
